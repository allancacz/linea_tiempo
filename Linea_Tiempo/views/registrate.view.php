	...
	<div class="contenedor">
		...
		<form class="formulario" name="login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
			<div class="form-group">
				<i class="icono izquierda fa fa-user"></i><input class="usuario" type="email" name="usuario" placeholder="Correo Electronico">
			</div>

			<div class="form-group">
				<i class="icono izquierda fa fa-user"></i><select class="usuario" name="tipo">
